<x-guest-layout>
    <!-- Main Hero Content -->
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center" style="background-image: url('https://cdn.pixabay.com/photo/2022/06/29/07/52/car-7291166_960_720.jpg')">
        <h1 class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 md:text-center sm:leading-none lg:text-5xl">
            <span class="inline md:block">Welcome To Car Wash</span>
        </h1>
            ...
            > -->
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="https://cdn.pixabay.com/photo/2017/09/14/17/39/auto-2749830_960_720.jpg" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img class="mx-auto sm:max-w-sm lg:max-w-full" src="https://cdn.pixabay.com/photo/2021/08/18/06/15/woman-6554725_960_720.jpg" alt="feature image"></div>
            </div>
        </div>
    </section>
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            <h3 class="text-2xl font-bold">Our Service</h3>
        </div>
            ...
            <div class="grid lg:grid-cols-4 gap-y-6">
                ...
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                    ...
                    <div class="flex items-center justify-between p-4">
                        <span class="text-xl text-green-600">IDR {{ $menu->price }}</span>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Oooh!</h2>
